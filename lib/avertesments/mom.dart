              ...
              child:Container(
                ...
                child: ListView(
                  children: [
                    Container(
                      child: ClipRRect(
                        child: Image.asset('asset/a2.jpg')
                        ,borderRadius: BorderRadius.circular(30.5),
                      ),
                    )
                    ,Container(
                      ...
                      child: ClipRRect(
                        child: Image.asset('asset/a3.jpg')
                        ,borderRadius: BorderRadius.circular(30.5),
                      ),
                    )
                    ,Container(
                      margin: EdgeInsets.only(top: 20),
                      child: ClipRRect(
                        child: Image.asset('asset/a4.jpg')
                        ,borderRadius: BorderRadius.circular(30.5),
                      ),
                    )
                    ,Container(
                      margin: EdgeInsets.only(top: 20),
                      child: ClipRRect(
                        child: Image.asset('asset/a5.jpg')
                        ,borderRadius: BorderRadius.circular(30.5),
                      ),
                    )
                    ,Container(
                      margin: EdgeInsets.only(top: 20),
                      child: ClipRRect(
                        child: Image.asset('asset/a6.jpg')
                        ,borderRadius: BorderRadius.circular(30.5),
                      ),
                    )
                  ],
